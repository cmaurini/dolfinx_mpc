...
from dolfinx_mpc import cpp as cpp
...
def assemble_vector_cpp(form: ufl.form.Form, constraint: MultiPointConstraint, b: PETSc.Vec = None,
                        form_compiler_parameters={}, jit_parameters={}):
    """
    Assemble a linear form into existing vector b. Non zeroing of data occurs.
    ...
    if b is None:
        ...
        b = dolfinx.cpp.la.create_vector(index_map, block_size)

    # Assemble matrix in C++
    cpp.mpc.assemble_vector(b, cpp_form, constraint._cpp_object)
